        ...
        <div class="fu-container__left">
          <div class="fu-container__block">
            <div class="fu-container__title">
              <span>图片上传</span>
              <span class="bulkSwitch"><el-switch @change="handBulkUpload" v-model="bulkUpload" active-text="批量上传"/></span>
            </div>
            <el-upload class="fu-container__upload"
              ...
              <template #tip>
                <div class="upload--tip">
                  仅支持jpg格式。图片命名需要以"患者ID"+"_left"或"_right"来区分左右眼
                </div>
              </template>
            </el-upload>
          </div>
